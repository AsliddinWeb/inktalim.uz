...
const routes = [
  // ─── Landing sahifa — hammaga ochiq ──────────────────────────────────────
  {
    ...
    meta: { title: 'EduUz — Bepul Online Ta\'lim Platformasi' },
  },
    ...
    children: [
      {
        ...
        name: 'Login',
        component: LoginView,
        meta: { title: 'Kirish — EduUz', guestOnly: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: 'Ro\'yxatdan o\'tish — EduUz', guestOnly: true },
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { title: 'Dashboard — EduUz', requiresAuth: true },
      },
      {
        path: 'courses',
        name: 'StudentCourses',
        component: StudentCourses,
        meta: { title: 'Kurslar — EduUz', requiresAuth: true },
      },
      {
        path: 'courses/:id',
        name: 'StudentCourseDetail',
        component: StudentCourseDetail,
        meta: { title: 'Kurs — EduUz', requiresAuth: true },
      },
      {
        path: 'courses/:courseId/lessons/:lessonId',
        name: 'lesson',
        component: StudentLesson,
        meta: { title: 'Dars — EduUz', requiresAuth: true },
      },
      {
        path: 'courses/:courseId/lessons/:lessonId/quiz',
        name: 'quiz',
        component: StudentQuiz,
        meta: { title: 'Test — EduUz', requiresAuth: true },
      },
      {
        path: 'progress',
        name: 'StudentProgress',
        component: StudentProgress,
        meta: { title: 'Mening progressim — EduUz', requiresAuth: true },
      },
      {
        path: 'profile',
        name: 'StudentProfile',
        component: StudentProfile,
        meta: { title: 'Profilim — EduUz', requiresAuth: true },
      },
      {
        path: 'certificates',
        name: 'StudentCertificates',
        component: StudentCertificates,
        meta: { title: 'Sertifikatlarim — EduUz', requiresAuth: true },
      },
      {
        path: 'certificates/:number',
        name: 'StudentCertificate',
        component: StudentCertificate,
        meta: { title: 'Sertifikat — EduUz', requiresAuth: true },
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { title: 'Admin Panel — EduUz', requiresAuth: true, requiresAdmin: true },
      },
      {
        path: 'courses',
        name: 'AdminCourses',
        component: AdminCourses,
        meta: { title: 'Kurslar boshqaruvi — EduUz', requiresAuth: true, requiresAdmin: true },
      },
      {
        path: 'courses/:id',
        name: 'AdminCourseDetail',
        component: AdminCourseDetail,
        meta: { title: 'Kurs darslar — EduUz', requiresAuth: true, requiresAdmin: true },
      },
      {
        path: 'users',
        name: 'AdminUsers',
        component: AdminUsers,
        meta: { title: 'Foydalanuvchilar — EduUz', requiresAuth: true, requiresAdmin: true },
      },
      {
        path: 'profile',
        name: 'AdminProfile',
        component: AdminProfile,
        meta: { title: 'Admin Profil — EduUz', requiresAuth: true, requiresAdmin: true },
      },
    ],
  },
  ...
  // ─── 404 — Topilmadi ─────────────────────────────────────────────────────
  {
    ...
    meta: { title: 'Sahifa topilmadi — EduUz' },
  },
]
